      ...
      <div ref={ref} className="max-w-container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3">
          {stats.map((stat, i) => (
            <div
              key={stat.number}
              className={`reveal delay-r${i + 1} py-10 px-6 md:px-12 flex flex-col gap-1.5 border-b md:border-b-0 md:border-r border-border last:border-r-0 last:border-b-0`}
            >
